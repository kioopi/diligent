...
local start_args = require("cli.validate_args")

describe("CLI Start Args", function()
  describe("validate_parsed_args", function()
    it("should accept project name only", function()
      ...
      local success, result = start_args.validate_parsed_args(args)
    ...
    it("should reject both project name and file path", function()
      ...
      local success, error_msg = start_args.validate_parsed_args(args)
  ...
  describe("get_error_type", function()
    it("should return MISSING_INPUT for no arguments", function()
      ...
      local error_type = start_args.get_error_type(args)

      assert.are.equal(start_args.ERROR_MISSING_INPUT, error_type)
    end)
    ...
    it("should return CONFLICTING_INPUT for both arguments", function()
      ...
      assert.are.equal(start_args.ERROR_CONFLICTING_INPUT, error_type)
    end)
  ...
  describe("constants", function()
    it("should define error type constants", function()
      assert.is_not_nil(start_args.ERROR_MISSING_INPUT)
      assert.is_not_nil(start_args.ERROR_CONFLICTING_INPUT)
      assert.are_not.equal(
        start_args.ERROR_MISSING_INPUT,
        start_args.ERROR_CONFLICTING_INPUT
      )
    end)

    it("should define input type constants", function()
      assert.is_not_nil(start_args.INPUT_TYPE_PROJECT)
      assert.is_not_nil(start_args.INPUT_TYPE_FILE)
      assert.are_not.equal(
        start_args.INPUT_TYPE_PROJECT,
        start_args.INPUT_TYPE_FILE
      )
    end)
  end)
end)
